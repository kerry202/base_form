package com.loan.dai.widget.progress;
...
public class MyProgress {
    ...
    /**
     * Create a new HUD. specify the HUD style (if you use a custom view, you need {@code MyProgress.create(Context context)}).
     *
     * @param context Activity context that the HUD bound to
     * @param style   One of the MyProgress.Style values
     * @return An unique HUD instance
     */
    public static MyProgress create(Context context, Style style) {
        return new MyProgress(context).setStyle(style);
    }
     ...
     * @return Current HUD
     */
    public MyProgress setSize(int width, int height) {
     ...
     * @return Current HUD
     */
    public MyProgress setBackgroundColor(int color) {
        mWindowColor = color;
        return this;
    }
     ...
     * @return Current HUD
     */
    public MyProgress setLabel(String label, int color) {
     ...
     * @return Current HUD
     */
    public MyProgress setDetailsLabel(String detailsLabel, int color) {
     ...
     * @return Current HUD
     */
    public MyProgress setCancellable(DialogInterface.OnCancelListener listener) {
     ...
     * @return Current HUD
     */
    public MyProgress setGraceTime(int graceTimeMs) {
